...
This project is a [fastlane](https://github.com/fastlane/fastlane) plugin. To get started with `fastlane-plugin-download_circleci_artifacts`, add it to your project by running:

```bash
fastlane add_plugin download_circleci_artifacts
```

## About download_circleci_artifacts
